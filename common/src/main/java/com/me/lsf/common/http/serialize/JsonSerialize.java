...
public class JsonSerialize implements LsfSerialize {
    ...
    private Object getObjectSuper(String content, Class<?> returnType, Type genericReturnType) {
        ...
        if (genericReturnType instanceof ParameterizedType) {
            ...
            if (result instanceof List) {
                ...
                Map<String, String> fieldSignMap = new HashMap<>();
                Integer cur = 0;
                for (Field field : returnType.getDeclaredFields()) {
                    ...
                    try {
                        ...
                        if (signObj != null) {
                            ...
                            fieldSignMap.put(cur.toString(), signObj.toString());
                            cur++;
                        }
                ...
                for (int i = 0; i < genericTypes.length; i++) {
                    ...
                    try {
                        ...
                        String sign = fieldSignMap.get(String.valueOf(i));
                        if (sign.startsWith("Ljava/util/List<")) {
                            List objList = (List) obj;
                            List resultList = new ArrayList(objList.size());
                            for (Object item : objList) {
                                Object two = getObjectJsonTwo(genericType, item);
                                resultList.add(two);
                            }
                            field.set(result, resultList);
                        } else {
