...
public class NettyHttpHandler extends SimpleChannelInboundHandler<FullHttpRequest> {
    ...
    private static Logger logger = LoggerFactory.getLogger(NettyHttpHandler.class);
    ...
    protected void channelRead0(ChannelHandlerContext ctx, FullHttpRequest msg) throws Exception {
        ...
        if (HttpHeaderValues.CLOSE.toString().equals(connection)) {
    ...
    public String dealMessage(FullHttpRequest httpRequest) throws Exception {
        ...
        try{
            ...
            if(HttpMethod.POST.equals(method)){
                ...
                try {
                    result = appServerHandler.synDeal(body);
                } catch (Exception e) {
